			...
			<div class="page-title">
					...
					<div>
						...
						<div style="float: left; padding-top: 12px; padding-left: 200px;">
							<input type="radio" name="fbType" value="all" > All Feedbacks 
							<input type="radio" name="fbType" value="unread" checked="checked"> Unread Feedbacks
							<input type="radio" name="fbType" value="read"> Read Feedbacks
									...
									<%-- <input type="hidden" name="userId" value="${userBean.userId}"> --%>
										...
										<textarea class="form-control" rows="3" name="feedBackResponse" ></textarea>
										  <br/>
												                    	...
												                    	<%-- <c:if test="${responseMailSent != null}">
												                    		<h4 style="color: green;" align="center">${responseMailSent}</h4></c:if> --%>
												                        ...
												                        <tr>
												                          ...
												                          <td>
												                             	...
												                             	<button class="getModal btn btn-primary btn-xs" 
													                            	...
													                            	<%-- <c:if test="${fb.readStatus == false}"> --%>
													                            	<a href="readFeedBack?id=${fb.id}" 
													                            		class="btn btn-info btn-xs" data-toggle="tooltip" 
													                            		title="Mark as read" data-placement="right">
													                            	<i class="fa fa-folder"></i> Read </a>
													                            	<%-- </c:if> --%>
													                            	
													                            	<%-- <c:if test="${fb.readStatus == true}"> --%>
													                            	<a href="readFeedBack?id=${fb.id}" 
													                            		class="btn btn-info btn-xs" data-toggle="tooltip" 
													                            		title="Mark as unread" data-placement="right">
													                            	<i class="fa fa-folder"></i> Unread </a>
													                            	<%-- </c:if> --%>
																	...
																	<c:forEach begin="1" end="${totalPages}" varStatus="loop">
																				...
																				<li class="btn-info btn-active" data-id="${loop.index}" >
																				<a href="viewFeedBacks?pageId=${loop.index}" id="btn-${loop.index}">${loop.index}</a>  
																					</li>      
