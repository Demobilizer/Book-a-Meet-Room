          ...
          <section class="login_content">
            ...
            <form action="${loginVar}" method="post">
              ...
              <c:if test="${regSuccess != null}">
					<p style="color: green;" align="center"> ${regSuccess} </p>
			</c:if>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form action="addUser" method="post" modelAttribute="userDto">
              ...
              <div>
                <input id="uName" type="text" class="form-control" placeholder="Create Username" required="required" name="userName" />
              </div>
              <div>
              ...
              <div>
                <input id="uEmail" type="email" class="form-control" placeholder="Email" required="required" name="emailId"/>
              </div>
              <div>
                <input id="uContact" type="text" class="form-control" placeholder="Contact No." required="required" name="contactNo"/>
              </div>
