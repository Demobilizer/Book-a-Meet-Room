        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="tlDashboard" class="site_title"><i class="fa fa-eye"></i> <span>Home</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="tlDashboard"><i class="fa fa-home"></i> Home </a></li>
                  ...
                  <li class="" id="lii"><a onclick="return theFunction();"><i class="fa fa-sitemap"></i> Manage User Req(s) <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" id="ull" style="display: none;" >
                        ...
                        <li><a href="">User Request </a>
                        </li>
                    </ul>
                  </li>
                  <li><a href=""><i class="fa fa-pencil-square"></i>View Assigned Users </a></li>
