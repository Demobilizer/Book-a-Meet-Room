            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="manageRoom"><i class="fa fa-institution"></i> View/ Manage Room(s) </a></li>
                  ...
                  <li><a href="manageBookingRequest?pageId=1"><i class="fa fa-institution"></i> Manage Room Requests </a></li>
